<div class="title-header">
    <h3>Sent Request ( <span>{{ count( $sent_request) }}</span> )</h3>
    <p>Members who you love to match with you</p>
</div>
@if(count($sent_request))
<div class="matches-request-container">
    <div class="row">
        @foreach($sent_request as $user)
                ...
                <div class="right-drop-down">
                    <div class="drop-down">
                        ...
                        <ul class="drop-down-body">
                            ...
                            <li>
                                <a href="#" data-name="{{ $user->user_name }}" id="{{ $user->like_id }}" class="delete-user-request-button">Cancel Request</a>
                            </li>
                        </ul>
                    </div>
                </div>
