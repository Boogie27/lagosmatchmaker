                     ...
                     <form action="{{ current_url() }}" method="POST">
                        <div class="row">
                            ...
                            <div class="col-xl-12 mt-4">
                                <div class="form-group">
                                    <button type="button" data-url="{{ url('/edit-life-style') }}" id="edit_life_style_submit_btn" class="btn-fill-block">Update Detail</button>
...
<!-- AJAX URLS -->
<a href="{{ url('/ajax-get-lifestyle') }}" id="ajax_get_lifestyle_url" style="display: none"></a>
...
function life_style(){
    $(".form_alert_0").html('')
    $(".alert-form").html('')
    var url = $("#edit_life_style_submit_btn").attr('data-url')
