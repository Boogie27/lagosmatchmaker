                                ...
                                <div class="member-inner-div"> 
                                    <div class="member-img">
                                        ...
                                        <ul class="ul-member-anchor" id="ul_member_anchor">
                                            ...
                                            @else
                                                @if(!is_blocked(user('id'), $premium->id))
                                                    ...
                                                    <li><a href="{{ url('/chat/'.$premium->id) }}" data-name="{{ $name }}" id="{{ $premium->id }}" title="Message"><i class="far fa-envelope"></i></a></li>
                                                    <li><a href="#" data-name="{{ $name }}" class="unlike-a-member-btn" id="{{ $premium->id }}" title="Unmatch"><i class="far fa-heart text-success"></i></a></li>
                                                    <li><a href="{{ url('/profile/'.$premium->id) }}" data-name="{{ $name }}" class="" title="Profile"><i class="fa fa-info"></i></a></li>
                                                    @endif
                                                    @if(get_like($premium->id) && user('id') == get_like($premium->id)->acceptor_id && !get_like($premium->id)->is_accept)
                                                    <li><a href="#" data-name="{{ $name }}" id="{{ $premium->id }}" class="cancle-user-like-request cancle-btn">Unmatch</a></li>
                                                    <li><a href="#"><i class="fa fa-heart text-danger"></i></a></li>
                                                    <li><a href="{{ url('/ajax-accept-like-request') }}" data-name="{{ $name }}" data-detail="{{ url('/ajax-get-matched-detail') }}" data-links="{{ url('/ajax-get-member-links') }}" id="{{ $premium->id }}" class="accept-user-like-request accept-btn">Match</a></li>
                                                    @endif
                                    ...
                                    <div class="member-body-div member-body-container">
                                        ...
                                        <div class="member-info-container">
                                            <ul class="ul-member-body">
                                                ...
                                                <li>HIV: <span>{{ $premium->HIV == 'YES' ? 'Positive' : 'Negative' }}</span></li>
