            ...
            <div class="container-fluid">
                <div class="row page-title">
                    <div class="col-md-12">
                        ...
                        <h4 class="mb-1 mt-0">Blocked members</h4>
                               ...
                               <div class="table-responsive" id="members_parent_table_container"> <!-- table start-->
                                    <table id="datatable-buttons" class="table table-striped dt-responsive nowrap">
                                        ...
                                        <tbody>
                                            ...
                                            @php($blocked_member = get_user($member->blocker))
                                            ...
                                            <tr>
                                                ...
                                                <td class="blocked-list">
                                                    <a href="{{ url('/admin/member-detail/'.$blocked_member->id) }}">
                                                        <ul>
                                                            <li><b>Name:</b> {{ $blocked_member->user_name }}</li>
                                                            <li> {{ $blocked_member->email }}</li>
                                                        </ul>
                                                    </a>
                                                </td>
