                    ...
                    <div class="col-md-12">
                        <nav aria-label="breadcrumb" class="float-right mt-1">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="javascript: void()">Saved</a></li>
                            </ol>
                        </nav>
                        <h4 class="mb-1 mt-0">Saved Newsletter</h4>
                            ...
                            <div class="card-body">
                                ...
                                <div class="parent-table-container" id="parent_table_container">
                                    ...
                                    <div id="bottom_table_part">
                                        @if(!count($newsletters))
                                        <div class="text-center">There are no saved newsletters yet!</div>
                                        @endif
                                        @if(count($newsletters))
...
function table_check(){
    ...
    if(table.length == 0){
        ...
        $("#bottom_table_part").html("<div class='text-center'>There are no saved newsletters yet!</div>")
    }
}
