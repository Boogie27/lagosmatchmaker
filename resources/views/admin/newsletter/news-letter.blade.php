                    ...
                    <div class="col-md-12">
                        <nav aria-label="breadcrumb" class="float-right mt-1">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="javascript: void()">Newsletters</a></li>
                            </ol>
                        </nav>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="table-top">
                                    ...
                                    <div class="table-top pb-2">
                                        <a href="#" id="compose_newsletter_subs_btn" class="mini-btn">Compose</a>
                                    </div>
                               </div>
    ...
    <div class="sub-confirm-container">
        <div class="sub-confirm-dark-theme">
            <div class="sub-inner-content">
                ...
                <div class="confirm-header">
                    <p>Do you wish to delete checked emails?</p>
                </div>
                <div class="confirm-form">
                    <form action="" method="POST">
