                                ...
                                <div class="card">
                                    <div class="card-body pt-2">
                                        ...
                                        <div class="media border-top pt-3">
                                            <img src="{{ asset('admins/images/users/avatar-7.jpg') }}" class="avatar rounded mr-3"
                                                alt="shreyu">
                                            <div class="media-body">
                                        ...
                                        <div class="media mt-1 border-top pt-3">
                                            <img src="{{ asset('admins/images/users/avatar-9.jpg') }}" class="avatar rounded mr-3"
                                                alt="shreyu">
                                            <div class="media-body">
                                        ...
                                        <div class="media mt-1 border-top pt-3">
                                            <img src="{{ asset('admins/images/users/avatar-4.jpg') }}" class="avatar rounded mr-3"
                                                alt="shreyu">
                                            <div class="media-body">
                                        ...
                                        <div class="media mt-1 border-top pt-3">
                                            <img src="{{ asset('admins/images/users/avatar-1.jpg') }}" class="avatar rounded mr-3"
                                                alt="shreyu">
                                            <div class="media-body">
                                        ...
                                        <div class="media mt-1 border-top pt-3">
                                            <img src="{{ asset('admins/images/users/avatar-5.jpg') }}" class="avatar rounded mr-3"
                                                alt="shreyu">
                                            <div class="media-body">
                                            ...
                                            <ul class="conversation-list slimscroll" style="max-height: 328px;">
                                                <li class="clearfix">
                                                    <div class="chat-avatar">
                                                        <img src="{{ asset('admins/images/users/avatar-9.jpg') }}" alt="Female">
                                                        <i>10:00</i>
                                                    </div>
                                                ...
                                                <li class="clearfix odd">
                                                    <div class="chat-avatar">
                                                        <img src="{{ asset('admins/images/users/avatar-7.jpg') }}" alt="Male">
                                                        <i>10:01</i>
                                                    </div>
                                                    <div class="conversation-text">
                                                        <div class="ctext-wrap">
